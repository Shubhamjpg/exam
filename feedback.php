  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91-9958157228</h4>
		<h4 style="font-family:'typo' ">info@ooency.com</h4>
		<h4 style="font-family:'typo' ">OOENCY is a global leading IT company introduced with the full of enthusiasm and expectation to provide the best IT services over IT and other industries. Ooency is better acquainted with the necessity of changing technology, as the various organizations are turning into online businesses.</h4></div></div>
		</p>
      </div>
