...
<div class="header">
    <div class="row">
        <div class="col-lg-6">
            <span class="logo"> QA professional </span></div>
                    ...
                    while($row = mysqli_fetch_array($result)) {
                        ...
                        if($rowcount == 0){
                            echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
	                            <td><b><a href="question.php?q=quiz&step=2&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:#99cc32"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Start</b></span></a></b></td></tr>';
